...
description: "How recurring markets on Outcome auto-deploy on a fixed cadence, like the daily BTC binary. See the redeploy cycle, spec, and why positions don't carry over."
---
