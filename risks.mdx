...
Outcome markets settle in USDC, which is issued by [<u>Circle</u>](https://www.circle.com/). Like any stablecoin, USDC carries issuer, custodian, peg, and regulatory risks separate from the Hyperliquid protocol itself.
