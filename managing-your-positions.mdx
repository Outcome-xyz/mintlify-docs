...
Your **cost basis** is the total amount you've paid for a position. If you bought 100 tokens at ¢40, your cost basis is 40 USDC. If you then bought 50 more tokens at ¢50, your cost basis is 65 USDC (40 + 25), and your average entry price is ¢43.333.
...
If you bought 100 tokens at ¢40 and the price is now ¢60, your unrealized gain is 20 USDC. If you sell those 100 tokens at ¢60, that 20 USDC becomes realized.
...
For example, if you hold 100 tokens with an average entry of ¢40 and sell 60 at ¢60, you realize a gain of 12 USDC on the 60 sold (60 × (¢60 − ¢40) ÷ 100). The remaining 40 tokens stay open at the same ¢40 average entry, with their own unrealized gain or loss based on the current market price.
...
<Note>
  **Note on units:** the UI displays prices in cents (e.g., ¢40). In the formulas below, prices are expressed as decimal USDC values: ¢40 = 0.40, ¢99.999 = 0.99999. All resulting amounts (cost basis, PnL, payoff) are in USDC.
</Note>
