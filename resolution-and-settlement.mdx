...
Settlement happens automatically. Your USDC balance updates with the redemption proceeds (minus the settlement fee, see Fees).
...
Settlement proceeds appear in your USDC balance immediately after the resolution timestamp passes and the protocol processes the settlement. You can see them in your portfolio on [outcome.xyz](http://outcome.xyz).