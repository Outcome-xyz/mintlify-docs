...
The full fee schedule, including tier breakpoints, the USDH discount, and the settlement fee, is on Hyperliquid's [<u>fees page</u>](https://hyperliquid.gitbook.io/hyperliquid-docs/trading/fees).