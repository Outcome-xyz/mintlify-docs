...
Because USDC is the quote currency for outcome markets, taker fees are 20% lower than the standard rate, and outcome volume counts 20% more toward your Hyperliquid fee tier.
...
The full fee schedule, including tier breakpoints, the USDC discount, and the settlement fee, is on Hyperliquid's [<u>fees page</u>](https://hyperliquid.gitbook.io/hyperliquid-docs/trading/fees).