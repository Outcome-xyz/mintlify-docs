...
The fee schedule differs between makers and takers. See [Fees](/fees) for current rates.
...
The minimum order size is 10 USDC in value. For a buy at C40 per token, that's at least 25 tokens. For a buy at C10 per token, at least 100 tokens. The minimum scales with the price so the total value stays at least 10 USDC.
