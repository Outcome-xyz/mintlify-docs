...
description: "A typed TypeScript SDK for building on HIP-4 - fetch markets, stream live data, place orders, run conversion primitives, and manage USDH funds on Hyperliquid."
---
