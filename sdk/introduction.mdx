---
title: "Outcome HIP-4 SDK: Prediction Markets on Hyperliquid"
description: "A fully typed TypeScript SDK for building on HIP-4 prediction markets — fetch markets, stream live data, place orders, and manage USDH funds."
---

Outcome is a prediction market platform built on Hyperliquid's HIP-4 protocol. HIP-4 extends Hyperliquid's L1 with binary outcome markets, where each outcome is traded as a probability token priced between 0 and 1. The `@outcomexyz/hip4-sdk` gives you everything you need to integrate these markets into your own application: market discovery, real-time WebSocket data, order placement with EIP-712 signing, and USDH fund management — all from a single, zero-dependency TypeScript package.

## Key features

<CardGroup cols={2}>
  <Card title="Market discovery" icon="magnifying-glass" href="/sdk/guides/fetch-markets">
  ...
  <Card title="Order trading" icon="arrows-left-right" href="/sdk/guides/trading">
