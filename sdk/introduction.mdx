...
description: "A typed TypeScript SDK for building on HIP-4 - fetch markets, stream live data, place orders, run conversion primitives, and manage your positions on Hyperliquid."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Fund management" icon="wallet" href="/sdk/reference/wallet-adapter">
    Deposit USDC to your prediction account and withdraw funds back to your wallet. Uses EIP-712 signing for transfers and L1 agent signing for spot trades.
  </Card>
</CardGroup>
