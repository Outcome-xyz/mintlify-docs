...
| `skipMinNotionalCheck` | `boolean` | No | Skip the configured minimum notional check; use for position-closing flows |
...
| `unrealizedPnl` | `string` | Unrealized profit/loss in USDC |
