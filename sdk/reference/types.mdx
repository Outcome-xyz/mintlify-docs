---
title: "TypeScript Types Reference for @hip4/sdk"
sidebarTitle: "Types"
description: "All exported TypeScript types from @hip4/sdk: market shapes, event and outcome types, order params, account state, and market data interfaces."
---

This page documents all exported TypeScript types from `@hip4/sdk`. Every type listed here is importable from the main entry point. If you only need types without pulling in any runtime code - for example in a shared type package - use the dedicated types entry point instead.

<Note>
  Import types without any runtime cost using `@hip4/sdk/types`:
