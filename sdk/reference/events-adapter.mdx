---
title: "Discover HIP-4 events, categories, and typed markets"
sidebarTitle: "Events"
...
<ParamField path="params.sortBy" default="newest" type="string">
...
<ParamField path="params.groupBy" type="string">
  ...
  (or `"standalone"` for unattached outcomes).
</ParamField>

<ParamField path="params.limit" default="100" type="number">
...
<Note>
  When using `groupBy`, `limit` and `offset` apply to the flat list before
