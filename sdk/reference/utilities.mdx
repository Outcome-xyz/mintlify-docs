...
description: "Pure utility functions from @outcomexyz/hip4-sdk for tick-aligned pricing, market discovery, coin name encoding, cost estimation, and price feed streams."
---
...
```typescript
import { computeTickSize } from "@outcomexyz/hip4-sdk";
...
```typescript
import { roundToTick } from "@outcomexyz/hip4-sdk";
...
```typescript
import { formatPrice } from "@outcomexyz/hip4-sdk";
...
```typescript
import { stripZeros } from "@outcomexyz/hip4-sdk";
...
```typescript
import { MIN_NOTIONAL } from "@outcomexyz/hip4-sdk";
...
```typescript
import { parseDescription } from "@outcomexyz/hip4-sdk";
...
```typescript
import { discoverPriceBinaryMarkets } from "@outcomexyz/hip4-sdk";
...
```typescript
import { periodMinutes } from "@outcomexyz/hip4-sdk";
...
```typescript
import { formatMarketLabel } from "@outcomexyz/hip4-sdk";
...
```typescript
import { timeToExpiry } from "@outcomexyz/hip4-sdk";
...
```typescript
import { classifyOutcome } from "@outcomexyz/hip4-sdk";
...
```typescript
import { classifyAllOutcomes } from "@outcomexyz/hip4-sdk";
...
```typescript
import { computeEstimatedCost } from "@outcomexyz/hip4-sdk";
...
```typescript
import { computeTradeCost } from "@outcomexyz/hip4-sdk";
import type { TradeCostResult } from "@outcomexyz/hip4-sdk";
...
```typescript
import { computePotentialReturn } from "@outcomexyz/hip4-sdk";
...
```typescript
import { createPriceFeed } from "@outcomexyz/hip4-sdk";
import type { PriceFeedSnapshot, PriceFeedOptions } from "@outcomexyz/hip4-sdk";
...
```typescript
import { HIP4Client, createPerpPriceFeed } from "@outcomexyz/hip4-sdk";
import type { PerpPriceFeedSnapshot } from "@outcomexyz/hip4-sdk";
