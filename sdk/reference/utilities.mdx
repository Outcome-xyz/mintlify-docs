...
description: "Pure utility functions from @hip4/sdk for tick-aligned pricing, market discovery, coin name encoding, cost estimation, and price feed streams."
---
...
```typescript
import { computeTickSize } from "@hip4/sdk";
...
```typescript
import { roundToTick } from "@hip4/sdk";
...
```typescript
import { formatPrice } from "@hip4/sdk";
...
```typescript
import { stripZeros } from "@hip4/sdk";
...
```typescript
import { MIN_NOTIONAL } from "@hip4/sdk";
...
```typescript
import { parseDescription } from "@hip4/sdk";
...
```typescript
import { discoverPriceBinaryMarkets } from "@hip4/sdk";
...
```typescript
import { periodMinutes } from "@hip4/sdk";
...
```typescript
import { formatMarketLabel } from "@hip4/sdk";
...
```typescript
import { timeToExpiry } from "@hip4/sdk";
...
```typescript
import { classifyOutcome } from "@hip4/sdk";
...
```typescript
import { classifyAllOutcomes } from "@hip4/sdk";
...
```typescript
import { sideCoin, sideAssetId, parseSideCoin, outcomeCoin } from "@hip4/sdk";
...
```typescript
import { computeEstimatedCost } from "@hip4/sdk";
...
```typescript
import { computeTradeCost } from "@hip4/sdk";
import type { TradeCostResult } from "@hip4/sdk";
...
import type { PriceFeedSnapshot, PriceFeedOptions } from "@hip4/sdk";
...
```typescript
import { HIP4Client, createPerpPriceFeed } from "@hip4/sdk";
import type { PerpPriceFeedSnapshot } from "@hip4/sdk";
