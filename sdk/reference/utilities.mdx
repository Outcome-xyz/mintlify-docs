...
Returns the minimum number of shares required to meet the 10 USDC minimum notional for a given mark price.
...
The minimum order size in USDC. Currently `10`. Orders below this threshold are rejected before submission.
