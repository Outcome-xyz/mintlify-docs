...
description: "Reference for PredictionTradingAdapter: place limit and market orders on HIP-4 outcomes, cancel resting orders, and run share-conversion primitives — split, merge, and negate."
---
...
Four protocol-level share-conversion primitives that move value between USDH and outcome tokens without touching the orderbook. They settle directly against your spot balances at the conservation-identity mint price — no spread paid, no slippage, no liquidity required. See the [Converting tokens concept](/platform/trading/converting) for the math, and the [Token conversions guide](/sdk/guides/conversions) for end-to-end code.
