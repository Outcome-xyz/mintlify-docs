...
<Tip>
  Use `testnet: true` while you're getting started. The Hyperliquid testnet
  gives you a free environment to experiment without risking real funds.
</Tip>
...
<Warning>
  Placing orders on mainnet (`testnet: false`) uses real funds. Make sure your
  account has sufficient USDH balance before submitting.
</Warning>
