...
description: "Install the sdk, hook up data fetching for live prediction markets, authenticate with an agent key, and place your first order. Five steps, here we go."
---
