---
title: "Quickstart: install and trade with the HIP-4 SDK"
sidebarTitle: "Quickstart"
description: "Install @outcomexyz/hip4-sdk, fetch live prediction markets, authenticate with an agent key, and place your first limit order — all in five steps."
---

This guide walks you through the full integration path — from installation to placing a live limit order on a HIP-4 prediction market. By the end, you'll have a working adapter, a list of available markets, and a submitted order you can verify on the Hyperliquid exchange.
...
Add `@outcomexyz/hip4-sdk` to your project:
...
const userAccount = privateKeyToAccount(process.env.PRIVATE_KEY as `0x${string}`);
