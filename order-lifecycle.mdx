---
title: "Order lifecycle: submission, resting, matching, fills"
description: "Follow an order from submission to fill on Outcome — when it rests on the book, how matching pairs makers and takers, partial fills, and how to cancel."
---
