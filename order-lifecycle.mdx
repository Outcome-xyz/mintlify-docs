...
To avoid slippage, use a limit order with a price you're willing to accept as your worst-case fill. See [Order types](/order-types) for the difference between limit and market orders.