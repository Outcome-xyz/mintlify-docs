...
description: "Prediction market shares pay 1 USDC if the event happens and 0 if it doesn't. Learn how prices reflect probabilities and why outcomes sum to one."
---
