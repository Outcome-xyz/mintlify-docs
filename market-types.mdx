...
description: "Outcome supports binary markets (YES/NO or UP/DOWN) and multi-outcome markets. See how each is structured, how prices sum to 1 USDH, and when to use them."
---
...
\$\$ \\text{settlement price} = \\text{markPrice}\_0 \+ \\frac{\\text{settlementTime} - t\_0}{t\_1 - t\_0} \\times (\\text{markPrice}\_1 - \\text{markPrice}\_0) \$\$

Where \$t\_0\$ and \$t\_1\$ are the timestamps of the mark price updates immediately before and after the settlement time.
