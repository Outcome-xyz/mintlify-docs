...
Once you have an open position, you can hold it until the market resolves or close it earlier by selling at the current market price. See [Closing a position](/closing-a-position) for both paths, or [Order types](/order-types) and [Reading the order book](/reading-the-order-book) for deeper coverage.