---
title: "Placing your first prediction market trade on Outcome"
sidebarTitle: "Placing your first trade"
description: "Enable one-signature trading on your wallet or Privy login, then submit a limit or market order on any Outcome prediction market in just a few clicks."
---
...
Once you have an open position, you can hold it until the market resolves or close it earlier by selling at the current market price. See [Closing a position](04d-closing-a-position.md) for both paths, or the [Trading guide](05-trading-guide.md) for deeper coverage of order types, the order book, and position management.